...
\033[1;91m--> GITHUB :- https://github.com/FAWAD5678/FawadXzahido786.git

\033[1;92m--> FACEBOOK :- Fawad Ali shah

\033[1;93m--> YOUTUBE :-  ZAHIDO.COM
...
CorrectUsername = "fawado"
CorrectPassword = "fawado"
...
while (loop == 'true'):
    ...
    if (username == CorrectUsername):
        ...
        if (password == CorrectPassword):
            print "Logged in successfully as " + username #Dev:fawado
	    time.sleep(2)
            loop = 'false'
        else:
...
def pilih_crack():
	...
	p.map(main, id)
	print "▤▤▤▤▤▤▤▤▤▤▤▤▤▤▤▤▤▤▤▤▤▤▤▤▤▤▤▤▤▤▤"
	print "  Written By FAWADO" #Dev:fawado
